...
import HorizontalRadioButtons from "./SelectExtractor";
...
const FileUpload = () => {
	...
	const [result, setResult] = useState({ extractor: "Scalpel" });
	...
	const sendFilesToServer = () => {
		...
		axios
			.post("http://127.0.0.1:5000/dump", { result })
			.then((response) => {
	...
	return (
		<div className="float-child">
			<div
				...
				className="drop-zone"
			>
				<HorizontalRadioButtons onChange={getRadio} />
				<div id="contents">
					<Image />
